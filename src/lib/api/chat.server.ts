...
import { month01Quotes } from "../../data/quotes/month01";
import { month02Quotes } from "../../data/quotes/month02";
import { month03Quotes } from "../../data/quotes/month03";
import { month04Quotes } from "../../data/quotes/month04";
import { month05Quotes } from "../../data/quotes/month05";
import { month06Quotes } from "../../data/quotes/month06";
import { month07Quotes } from "../../data/quotes/month07";
import { month08Quotes } from "../../data/quotes/month08";
import { month09Quotes } from "../../data/quotes/month09";
import { month10Quotes } from "../../data/quotes/month10";
import { month11Quotes } from "../../data/quotes/month11";
import { month12Quotes } from "../../data/quotes/month12";
...
function buildProjectContext(messages: ChatMessage[], routeContext: RouteContext) {
  ...
  const chapterLines = chapters
    .map((chapter) => `Chương ${chapter.n}: ${chapter.title} - ${chapter.sub}`)
    .join("\n");
